...
CFLAGS = -DSPIKERT $(COPTS) $(CDEFS) $(INCLUDES)
#
#  アプリケーションプログラムに関する定義
#
APPLNAME = @(APPLNAME)
...
#
$(OBJNAME).bin: $(OBJFILE)
ifneq ("$(wildcard HUB_NAME)","")
	$(OBJCOPY) --update-section .name=HUB_NAME -O binary -S $(OBJFILE) $(OBJNAME).bin
else
...
clean:
	...
	rm -f $(OBJFILE) $(OBJNAME).syms $(OBJNAME).srec $(OBJNAME).bin $(OBJNAME).dfu HUB_NAME
